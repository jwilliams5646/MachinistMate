...
/**
 * Created by john.williams on 5/6/2014.
 */
public class LengthdbHelper extends SQLiteOpenHelper {
    ...
    private static String TABLE_NAME = "length";
     ...
     * @param context
     */
    public LengthdbHelper(Context context) {
